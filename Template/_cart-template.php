        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">Samsung Galaxy s23 Ultra</h5>
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-rale font-size-14">1,534 ratings</a>
                        </div>
                        <!--  !product rating-->
                    ...
                    <div class="col-sm-2 text-right">
                        <div class="font-size-20 text-danger font-baloo">
                            ₹<span class="product_price">124999</span>
                        </div>
                    </div>
                </div>
                <!-- !cart item -->
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="./assets//products/iphone14.png" style="height: 120px;" alt="cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">iPhone 14 Pro</h5>
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-rale font-size-14">2,534 ratings</a>
                        </div>
                        <!--  !product rating-->
                    ...
                    <div class="col-sm-2 text-right">
                        <div class="font-size-20 text-danger font-baloo">
                            ₹<span class="product_price">129000</span>
                        </div>
                    </div>
                </div>
                <!-- !cart item -->
